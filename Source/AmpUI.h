...
public:
    ...
    void paintModule(Graphics& g) override {
        ...
        paintComponentLabel(g, &modAmt, "mod amt", TOP, getHeight() * 0.03, textCol);
        paintComponentLabel(g, getCvInputJack(0), "in", TOP, getHeight() * 0.03, textCol);
        paintComponentLabel(g, getCvInputJack(1), "gain", TOP, getHeight() * 0.03, textCol);
    ...
    void resized() override {
        ...
        modAmt.setSize(40, 40);
        modAmt.setCentrePosition(getWidth() / 2, getHeight() * 0.5);
        getCvInputJack(0)->setCentrePosition(getWidth()/2 - getWidth() * 0.2, getHeight() * 0.95);
        getCvInputJack(1)->setCentrePosition(getWidth()/2 - getWidth() * 0.2, getHeight() * 0.80);
