...
static float lfsquaredsp_faustpower3_f(float value) {
	return value * value * value;
}
static float lfsquaredsp_faustpower2_f(float value) {
	return value * value;
}
...
class lfsquaredsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = 0.041666668f * lfsquaredsp_faustpower2_f(fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec1[0] = 0.999f * fRec1[1] + fConst5 * (fTemp7 - fVec4[(IOTA0 - iTemp9) & 4095] * fTemp13 - fTemp12 * fVec4[(IOTA0 - iTemp10) & 4095]);
			fRec3[0] = fTemp3 + 0.999f * fRec3[1] + (-1.0f - (fTemp13 * fVec1[(IOTA0 - iTemp9) & 4095] + fTemp12 * fVec1[(IOTA0 - iTemp10) & 4095]));
			output0[i0] = FAUSTFLOAT(((fRec0[0] < 3e+01f) ? fConst6 * fRec0[0] * fRec3[0] : fConst6 * fRec0[0] * fRec1[0]));
			iVec0[2] = iVec0[1];
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
