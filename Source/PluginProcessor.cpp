...
//==============================================================================
const juce::String SuperModularAudioProcessor::getName() const
{
...
const juce::String SuperModularAudioProcessor::getProgramName (int index)
{
    return {};
}

void SuperModularAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void SuperModularAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
juce::AudioProcessorEditor* SuperModularAudioProcessor::createEditor()
{
    return new SuperModularAudioProcessorEditor (*this);
}

//==============================================================================
void SuperModularAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
